    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                @if(isset($_GET["type"]))
                <a class="btn btn-sm btn-primary float-right d-inline" href="{{ route('book.index') }}"><i class="fa fa-angle-double-left"></i> {{trans('messages.back') }}</a>
                @endif
                <a class="btn btn-sm btn-primary float-right d-inline" href="{{ route('book.index',['type' => 'top-sell']) }}"><i class="fa fa-book"  ></i> {{ trans('messages.top_selling_book') }}</a>
                <a class="btn btn-sm btn-primary float-right d-inline mx-1" href="{{ route('book.index',['type' => 'recommended']) }}"><i class="fa fa-book"  ></i> {{ trans('messages.recommended_book') }}</a>
