...
<div class="col-md-6 offset-md-3">
    <div class="card">
        ...
        <div class="card-block pall-10">
            {!! Form::open(['route' => 'staticdata.update','data-toggle'=>"validator"])!!}
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            {!! Form::text('name', isset($data->value) ? $data->value : '' ,['class'=>'form-control', 'required', 'placeholder' => trans('messages.enter_field_name',['field' => ucfirst($type)]) ])!!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::submit(trans('messages.update'),['class' => 'btn btn-md btn-primary']) !!}
                        </div>
                    </div>
                </div>
            {!! Form::close() !!}
