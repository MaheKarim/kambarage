...
<div class="col-md-12">
    <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-sm btn-primary float-right d-inline ml-1" href="{{ route('mobile_app.config') }}"><i class="fa fa-angle-double-left"></i> {{trans('messages.back') }}</a>
                        ...
                        <div class="row" id='newapp'>
                            <div class="col-md-12">
                                    <data-table class="table text-center table-responsive-sm md-responsive"  ajax="{{ route('mobileslider.list') }}" :columns="[
                                        ...
                                        {data: 'position' ,'name': 'position' , 'title' :'{{ trans('messages.position')}}'},
