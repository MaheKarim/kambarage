        ...
        <div class="card-block pall-10">
            ...
            {!! Form::hidden('mobile_slider_id', isset($slider_data->mobile_slider_id) ? $slider_data->mobile_slider_id : '') !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!!Form::label('country',trans('messages.position',).' *',['class'=>'form-control-label'])!!}
                            {!! Form::select('position', ["top" => "Top","bottom" => "Bottom"], isset($slider_data->position)?$slider_data->position:"top", ['class'=>'form-control', 'required' ])!!}
