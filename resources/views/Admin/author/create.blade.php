                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="custom-file">
                                    {!! Form::file('image', ['id'=>"image", 'class'=>"custom-file-input custom-file-input-sm detail form-control-sm", 'accept'=>'image/*', 'onchange'=>"readURL(this);"]) !!}
                                    {!!Form::label('Image',isset($author_data->image) ? $author_data->image : '',array('id'=>'imagelabel','class'=>'custom-file-label',''))!!}
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="hw-150 m-auto">
                                    <img id="author_profile" src="{{getSingleMedia($author_data,'image',null)}}" class="h-100 obj-fit-cov rounded-circle w-100 image mt-10">
                                </div>
                            </div>
                        </div>
                    </div>
