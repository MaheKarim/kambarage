...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            @if($auth_user->id === 1)
                <a class="btn btn-sm btn-primary float-right d-inline" href="{{ route('mobile_app.config') }}"><i class="fa fa-mobile-alt"  ></i> {{ trans('messages.mobile')}} {{trans('messages.settings') }}</a>
            @endif
            </h2>
        </div>
        <div class="card-body">
