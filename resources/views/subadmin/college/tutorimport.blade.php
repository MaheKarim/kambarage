...
<div class="col-md-6 offset-md-3">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('school.tutor', [$college_id]) }}" class="btn btn-sm btn-primary float-right d-inline"><i class="fa fa-angle-double-left"></i> {{ trans('messages.back') }}</a>
        </div>
        <div class="card-block pall-10">    
            <p><span>Your Excel/CSV file should contain 5 colums, arranged in the following order:<br>
                Name, email, Employee Number, contact Number, password
             </span></p>
             <p><span>DO NOT HAVE A HEADER/HEADING ON YOUR IMPORT FILE</span></p>
            <form method="POST" enctype="multipart/form-data" action="{{ route('tutor.import', [$college_id]) }}">
            {{ csrf_field() }}
