    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('student.create', [$college_id]) }} " class="btn btn-sm float-right btn-primary"><i class="fa fa-plus-circle"  ></i> {{ trans('messages.add_button_form',['form' => trans('messages.student')  ]) }}</a>
                <a href="{{ route('student.import.form', [$college_id]) }} " class="btn btn-sm float-right btn-primary mx-1"><i class="fa fa-plus-circle"  ></i> {{ trans('messages.import_button_form',['form' => trans('messages.student')  ]) }}</a>
            </div>
            <div class="card-body">
                <div class="card-block pall-10 text-center">
                    <div>
                        <data-table class="table table-responsive-sm md-responsive" ajax="{{ route('student.list', [$college_id]) }}" :columns="[
