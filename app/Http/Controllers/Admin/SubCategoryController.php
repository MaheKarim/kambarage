...
class SubCategoryController extends Controller
{
    ...
    {
        if(!Auth::user()->allowedAccess("category"))
        {
    ...
    public function list(Request $request){
        ...
        ->editColumn('action', function ($query) {
            ...
            <a onclick="return confirm(\'Are you sure?\')" title = "'.trans('messages.delete').'" class="btn btn-sm btn-danger" href="'.route('subcategory.destroy', ['id' => $query->subcategory_id]).'">
